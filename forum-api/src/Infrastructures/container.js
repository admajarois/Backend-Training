...
const LoginUserUseCase = require('../Applications/use_case/user/LoginUserUseCase');
...
const GetReplyUseCase = require('../Applications/use_case/replies/GetReplyUseCase');
